...
def default_argument_parser():
    ...
    port = 2 ** 15 + 2 ** 14 + hash(os.getuid() if sys.platform != "win32" else 1) % 2 ** 14 + random.randint(0,50)
...
class DefaultTrainer(TrainerBase):
    ...
    def build_evaluator(cls, cfg, dataset_name, output_dir=None):
        ...
        return data_loader, ReidEvaluator(cfg, num_query, dataset_name, output_dir)
