...
class ReidEvaluator(DatasetEvaluator):
    def __init__(self, cfg, num_query, dataset_protocol, output_dir=None):
        self.cfg = cfg
        self._num_query = num_query
        self._output_dir = output_dir
        self._use_dataset_protocol = dataset_protocol
    ...
    def process(self, inputs, outputs):
        prediction = {
            ...
            'camids': inputs['camids'].to(self._cpu_device) if isinstance(inputs['camids'], list) == False else inputs['camids']
        }
    ...
    def evaluate(self):
        ...
        cmc, all_AP, all_INP = evaluate_rank(dist, query_pids, gallery_pids, query_camids, gallery_camids, self._use_dataset_protocol)
